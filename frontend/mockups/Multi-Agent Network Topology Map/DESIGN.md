...
Optional (Phase 8): any retained agent view summarizes actual job and data provenance. Agent activity does not establish physical weather-chemistry coupling or replace the numerical worker.
