...
Required experiment comparison (Phases 3-6): show genuine feedback-on/off and fire-on/off runs with matching inputs and IDs. Keep any legacy 12-hour ML scenario explicitly labeled; do not stretch it into a claimed coupled 72-hour result.
