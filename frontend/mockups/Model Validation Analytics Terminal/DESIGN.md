...
Required validation view (Phases 5 and 7): display computed held-out metrics for pollutants and leads 1-24, 25-48 and 49-72 hours, baseline comparisons, counts and uncertainty. Remove fixed RMSE/convergence claims from the active implementation.
