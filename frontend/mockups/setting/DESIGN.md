...
Required supporting view (Phase 6): configure NCR domain, selected run, source freshness, units and UTC/IST display. Controls must persist real settings; a visual toggle is not operational evidence.
