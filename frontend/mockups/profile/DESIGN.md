...
Optional (Phase 8): retain only useful user preferences. Remove inherited fictional official identities from any scientific demonstration; profiles do not contribute to R1-R8 completion.
