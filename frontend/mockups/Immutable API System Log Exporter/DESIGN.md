...
Supporting provenance view (Phases 5-7): export run IDs, timestamps, configuration/input hashes and generated evaluation evidence. Hashes alone do not establish immutability or official authority.
