...
Optional (Phase 8): translate verified forecast summaries only after scientific acceptance. Preserve pollutant names, units, timestamps and uncertainty; simulated text streams are not evidence of ingestion or forecasting.
