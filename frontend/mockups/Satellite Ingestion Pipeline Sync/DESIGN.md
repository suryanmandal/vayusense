...
Required supporting ingestion view (Phases 1-2 and 6): parameterize NCR, fix the UI/handler route mismatch, retain product time/QA/units and show request failures. NO2 column imagery is not surface PM2.5 or a transported biomass plume.
